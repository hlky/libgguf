# ERNIE Turbo UD-Q5_K_M vs Standard Q5_K_M

Source: `unsloth/ERNIE-Image-Turbo-GGUF`, comparing `ernie-image-turbo-Q5_K_M.gguf` to `ernie-image-turbo-UD-Q5_K_M.gguf`.

## Transition Summary

| Standard qtype | UD qtype | Count |
|---|---|---:|
| `Q5_K` | `Q6_K` | 116 |
| `Q6_K` | `Q8_0` | 33 |
| `Q5_K` | `Q8_0` | 23 |
...
| `attn.out` | `Q5_K` -> `Q8_0` | 11 |
| `attn.out` | `Q6_K` -> `Q5_K` | 2 |
| `attn.out` | `Q6_K` -> `Q8_0` | 2 |
| `attn.q` | `Q5_K` -> `Q6_K` | 18 |
| `attn.q` | `Q5_K` -> `Q8_0` | 7 |
| `attn.q` | `Q6_K` -> `Q5_K` | 2 |
| `attn.q` | `Q6_K` -> `Q8_0` | 2 |
...
| `mlp.gate` | `Q5_K` -> `Q8_0` | 1 |
| `mlp.gate` | `Q6_K` -> `Q5_K` | 2 |
| `mlp.gate` | `Q6_K` -> `Q8_0` | 2 |
| `mlp.up` | `Q5_K` -> `Q6_K` | 23 |
| `mlp.up` | `Q6_K` -> `Q5_K` | 2 |
| `mlp.up` | `Q6_K` -> `Q8_0` | 2 |
...
| Layer | Tensor role | Tensor | Standard policy | UD policy |
|---:|---|---|---|---|
| 0 | `mlp.gate` | `layers.0.mlp.gate_proj.weight` | `Q6_K` | `Q8_0` |
| 0 | `mlp.fc2` | `layers.0.mlp.linear_fc2.weight` | `Q6_K` | `Q8_0` |
| 0 | `mlp.up` | `layers.0.mlp.up_proj.weight` | `Q6_K` | `Q8_0` |
| 0 | `attn.k` | `layers.0.self_attention.to_k.weight` | `Q6_K` | `Q8_0` |
| 0 | `attn.out` | `layers.0.self_attention.to_out.0.weight` | `Q6_K` | `Q8_0` |
| 0 | `attn.q` | `layers.0.self_attention.to_q.weight` | `Q6_K` | `Q8_0` |
| 0 | `attn.v` | `layers.0.self_attention.to_v.weight` | `Q6_K` | `Q8_0` |
| 1 | `mlp.gate` | `layers.1.mlp.gate_proj.weight` | `Q6_K` | `Q8_0` |
| 1 | `mlp.fc2` | `layers.1.mlp.linear_fc2.weight` | `Q6_K` | `Q8_0` |
| 1 | `mlp.up` | `layers.1.mlp.up_proj.weight` | `Q6_K` | `Q8_0` |
| 1 | `attn.k` | `layers.1.self_attention.to_k.weight` | `Q6_K` | `Q8_0` |
| 1 | `attn.out` | `layers.1.self_attention.to_out.0.weight` | `Q6_K` | `Q8_0` |
| 1 | `attn.q` | `layers.1.self_attention.to_q.weight` | `Q6_K` | `Q8_0` |
...
| 34 | `mlp.gate` | `layers.34.mlp.gate_proj.weight` | `Q6_K` | `Q5_K` |
| 34 | `mlp.fc2` | `layers.34.mlp.linear_fc2.weight` | `Q6_K` | `Q5_K` |
| 34 | `mlp.up` | `layers.34.mlp.up_proj.weight` | `Q6_K` | `Q5_K` |
| 34 | `attn.k` | `layers.34.self_attention.to_k.weight` | `Q6_K` | `Q5_K` |
| 34 | `attn.out` | `layers.34.self_attention.to_out.0.weight` | `Q6_K` | `Q5_K` |
| 34 | `attn.q` | `layers.34.self_attention.to_q.weight` | `Q6_K` | `Q5_K` |
| 35 | `mlp.gate` | `layers.35.mlp.gate_proj.weight` | `Q6_K` | `Q5_K` |
| 35 | `mlp.fc2` | `layers.35.mlp.linear_fc2.weight` | `Q6_K` | `Q5_K` |
| 35 | `mlp.up` | `layers.35.mlp.up_proj.weight` | `Q6_K` | `Q5_K` |
| 35 | `attn.k` | `layers.35.self_attention.to_k.weight` | `Q6_K` | `Q5_K` |
| 35 | `attn.out` | `layers.35.self_attention.to_out.0.weight` | `Q6_K` | `Q5_K` |
| 35 | `attn.q` | `layers.35.self_attention.to_q.weight` | `Q6_K` | `Q5_K` |
