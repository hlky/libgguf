...
static inline void libgguf_iq3_xxs_store8_sse4_1(float *RESTRICT y, const uint8_t *RESTRICT grid1, const uint8_t *RESTRICT grid2, uint8_t signs, __m128 db)
{
...
extern "C" void dequantize_row_iq3_xxs_sse4_1(const block_iq3_xxs *RESTRICT x, float *RESTRICT y, int64_t k)
{
  ...
  for (int i = 0; i < nb; ++i)
  {
    ...
    for (int ib32 = 0; ib32 < QK_K / 32; ++ib32)
    {
      ...
      for (int l = 0; l < 4; ++l)
      {
        ...
        libgguf_iq3_xxs_store8_sse4_1(yb + 32 * ib32 + 8 * l, grid1, grid2, signs, db);
      }
    }
  }
#else
