...
static inline __m128i q4_1_quantize_4_i32_sse2(const float *RESTRICT x, __m128 minv, __m128 id, __m128 half)
{
...
extern "C" void quantize_row_q4_1_sse2(const float *RESTRICT x, block_q4_1 *RESTRICT y, int64_t k)
{
  ...
  for (int i = 0; i < nb; ++i)
  {
    ...
    {
      const __m128i lo0 = q4_1_quantize_4_i32_sse2(xb + j, minv, idv, half);
      const __m128i lo1 = q4_1_quantize_4_i32_sse2(xb + j + 4, minv, idv, half);
      const __m128i hi0 = q4_1_quantize_4_i32_sse2(xb + QK4_1 / 2 + j, minv, idv, half);
      const __m128i hi1 = q4_1_quantize_4_i32_sse2(xb + QK4_1 / 2 + j + 4, minv, idv, half);
