...
static inline void libgguf_q4_k_store16_sse4_1(float *RESTRICT y, __m128i q8, __m128 d, __m128 m)
{
...
extern "C" void dequantize_row_q4_K_sse4_1(const block_q4_K *RESTRICT x, float *RESTRICT y, int64_t k)
{
  ...
  for (int i = 0; i < nb; ++i)
  {
    ...
    for (int j = 0; j < QK_K; j += 64)
    {
      ...
      libgguf_q4_k_store16_sse4_1(yb + j + 0, lo0, d1, m1);
      libgguf_q4_k_store16_sse4_1(yb + j + 16, lo1, d1, m1);
      libgguf_q4_k_store16_sse4_1(yb + j + 32, hi0, d2, m2);
      libgguf_q4_k_store16_sse4_1(yb + j + 48, hi1, d2, m2);
