...
static inline void libgguf_q5_k_store16_sse2(float *RESTRICT y, __m128i q8, __m128 d, __m128 m)
{
...
extern "C" void dequantize_row_q5_K_sse2(const block_q5_K *RESTRICT x, float *RESTRICT y, int64_t k)
{
  ...
  for (int i = 0; i < nb; ++i)
  {
    ...
    for (int j = 0; j < QK_K; j += 64)
    {
      ...
      libgguf_q5_k_store16_sse2(yb + j + 0, lo0, d1, m1);
      libgguf_q5_k_store16_sse2(yb + j + 16, lo1, d1, m1);
      libgguf_q5_k_store16_sse2(yb + j + 32, hi0, d2, m2);
      libgguf_q5_k_store16_sse2(yb + j + 48, hi1, d2, m2);
