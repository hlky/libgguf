...
static inline void libgguf_q3_k_store16_sse2(float *RESTRICT y, __m128i q8, __m128 d)
{
...
extern "C" void dequantize_row_q3_K_sse2(const block_q3_K *RESTRICT x, float *RESTRICT y, int64_t k)
{
  ...
  for (int i = 0; i < nb; ++i)
  {
    ...
    for (int n = 0; n < QK_K; n += 128)
    {
      for (int shift = 0; shift < 8; shift += 2)
      {
        ...
        libgguf_q3_k_store16_sse2(yb + n + (shift / 2) * 32 + 0, q1, d1);
        ...
        libgguf_q3_k_store16_sse2(yb + n + (shift / 2) * 32 + 16, q2, d2);
