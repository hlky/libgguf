...
static inline __m128i tq2_0_round_away_from_zero_4_sse2(
    __m128 v,
    __m128 id,
    __m128 sign_mask,
    __m128 half,
...
static inline __m128i tq2_0_quantize_8_i16_sse2(
    ...
    __m128i one)
{
  const __m128i q0 = tq2_0_round_away_from_zero_4_sse2(_mm_loadu_ps(x), id, sign_mask, half, zero, one);
  const __m128i q1 = tq2_0_round_away_from_zero_4_sse2(_mm_loadu_ps(x + 4), id, sign_mask, half, zero, one);
...
extern "C" void quantize_row_tq2_0_sse2(const float *RESTRICT x, block_tq2_0 *RESTRICT y, int64_t k)
{
  ...
  for (int64_t i = 0; i < nb; ++i)
  {
    ...
    for (size_t j = 0; j < sizeof(y->qs); j += 32)
    {
      ...
      {
        const __m128i q0 = tq2_0_quantize_8_i16_sse2(src + m, idv, sign_mask, half, zero, one);
        const __m128i q1 = tq2_0_quantize_8_i16_sse2(src + m + 32, idv, sign_mask, half, zero, one);
        const __m128i q2 = tq2_0_quantize_8_i16_sse2(src + m + 64, idv, sign_mask, half, zero, one);
        const __m128i q3 = tq2_0_quantize_8_i16_sse2(src + m + 96, idv, sign_mask, half, zero, one);
