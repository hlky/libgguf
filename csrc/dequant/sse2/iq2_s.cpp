...
static inline void libgguf_iq2_s_store8_sse2(float *RESTRICT y, const uint8_t *RESTRICT grid, uint8_t signs, __m128 db)
{
...
extern "C" void dequantize_row_iq2_s_sse2(const block_iq2_s *RESTRICT x, float *RESTRICT y, int64_t k)
{
  ...
  for (int i = 0; i < nb; ++i)
  {
    ...
    for (int ib32 = 0; ib32 < QK_K / 32; ++ib32)
    {
      ...
      for (int l = 0; l < 4; ++l)
      {
        ...
        libgguf_iq2_s_store8_sse2(yb + 32 * ib32 + 8 * l, grid, signs[l], l < 2 ? db0 : db1);
      }
      qs += 4;
      signs += 4;
    }
