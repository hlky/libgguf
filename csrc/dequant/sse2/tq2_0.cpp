...
static inline void libgguf_tq2_0_store16_sse2(float *RESTRICT y, __m128i q8, __m128 d)
{
...
extern "C" void dequantize_row_tq2_0_sse2(const block_tq2_0 *RESTRICT x, float *RESTRICT y, int64_t k)
{
  ...
  for (int i = 0; i < nb; ++i)
  {
    ...
    for (int j = 0; j < (int)sizeof(x->qs); j += 32)
    {
      ...
      for (int shift = 0; shift < 8; shift += 2)
      {
        ...
        libgguf_tq2_0_store16_sse2(yb + out + 0, q0, d);
        libgguf_tq2_0_store16_sse2(yb + out + 16, q1, d);
      }
    }
  }
#else
