...
static inline void libgguf_iq1_m_store8_sse4_1(float *RESTRICT y, const int8_t *RESTRICT grid, __m128 dl, __m128 delta)
{
...
extern "C" void dequantize_row_iq1_m_sse4_1(const block_iq1_m *RESTRICT x, float *RESTRICT y, int64_t k)
{
  ...
  for (int i = 0; i < nb; ++i)
  {
    ...
    for (int ib = 0; ib < QK_K / 32; ++ib)
    {
      ...
      libgguf_iq1_m_store8_sse4_1(yb + 32 * ib + 0, (const int8_t *)(iq1s_grid + idx0), dl1, _mm_set1_ps((qh[0] & 0x08) ? -IQ1S_DELTA : IQ1S_DELTA));
      libgguf_iq1_m_store8_sse4_1(yb + 32 * ib + 8, (const int8_t *)(iq1s_grid + idx1), dl1, _mm_set1_ps((qh[0] & 0x80) ? -IQ1S_DELTA : IQ1S_DELTA));
      libgguf_iq1_m_store8_sse4_1(yb + 32 * ib + 16, (const int8_t *)(iq1s_grid + idx2), dl2, _mm_set1_ps((qh[1] & 0x08) ? -IQ1S_DELTA : IQ1S_DELTA));
      libgguf_iq1_m_store8_sse4_1(yb + 32 * ib + 24, (const int8_t *)(iq1s_grid + idx3), dl2, _mm_set1_ps((qh[1] & 0x80) ? -IQ1S_DELTA : IQ1S_DELTA));
    }
  }
#else
