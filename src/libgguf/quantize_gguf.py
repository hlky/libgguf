...
from .quantize import convert_to_gguf, parse_qtype, parse_tensor_qtype
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Directly quantize safetensors/ckpt diffusion models to GGUF")
